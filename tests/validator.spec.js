...
describe('validate',()=>{
    ...
    // it('returns isValid as false if isAlpha(false) is passed without parameter(strict) and value has no alphabetic characters', () => {
    ...
    // it('returns isValid as truie if isAlpha(false) is passed without parameter(strict) and value has space with alphabetic characters', () => {
